...
export class Heading extends Component {
  static displayName = Heading.name;

  render() {
    return (
      <div>
       <h2>Welcome to the NCAA March Madness hub!</h2>
       <p>Here you can track down all of your favorite teams, their mascots, and where they are from!</p>
